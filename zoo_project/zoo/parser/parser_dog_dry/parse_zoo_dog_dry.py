...
def download_image(url, count=0):
    file_name_image = f"image/image_dog_dry/{count}.png"
    file_name = f"../../../../frontend/public/image/image_dog_dry/{count}.png"
...
def parse_zoo():
    url1 = ["https://zoobaza.by/dlya-sobak/vlazhnyj-korm-dlya-sobak/?page=2"]
    count_image = 147
    for i in url1:
        ...
        for i in range(24):
            ...
            count_image += 1
            time.sleep(1)
            print(price, id_image, count_product,  name,  title, weight, age_of_the_animal, animal_size, availability, price, description, link, image_link, manufacturer, old_price, sale,  sep="\n")
